...
export class NavbarComponent implements OnInit{
    ...
    constructor(location:Location, private renderer : Renderer, private element : ElementRef, public global_service:GlobalService, public router:Router, private route:ActivatedRoute) {
